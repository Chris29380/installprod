 ...
 */
$cfg['blowfish_secret'] = 'L08cV^-(FiBC<4cg8L(KJokmjfbRF\>Z'; /* YOU MUST FILL IN THIS FOR COOKIE AUTH! */
...
$cfg['Servers'][$i]['controluser'] = 'user_here';
$cfg['Servers'][$i]['controlpass'] = 'pwd_here';
